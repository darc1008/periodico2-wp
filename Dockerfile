...
COPY mariadb.cnf /etc/mysql/conf.d/periodico2.cnf
...
ENV MARIADB_DATABASE=periodico2
ENV MARIADB_USER=periodico2
ENV MARIADB_PASSWORD=P3r10d1c02_M4r1adb_2026!
ENV MARIADB_ROOT_PASSWORD=P3r10d1c02_R00t_2026!
